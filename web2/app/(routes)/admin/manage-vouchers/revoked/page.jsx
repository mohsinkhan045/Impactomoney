...
export default function RevokedVouchers() {
  return (
    <div className="p-6">
{/* <<<<<<< HEAD */}
      <h2 className="text-2xl font-bold mb-4">Revoked Vouchers</h2>
      ...
      <div className="overflow-y-auto">
        <table className="table-auto w-full border-collapse bg-white shadow-md rounded-lg">
          <thead className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
            <tr>
              {["Revoked Voucher ID", "Voucher ID", "Service Provider ID", "Beneficiary ID", "Revoked Amount" , "Revoked Date"].map((header)=>(
          ...
          <tbody className="text-gray-600 text-sm font-light">
            {mockRevokedVouchers.map((voucher) => (
