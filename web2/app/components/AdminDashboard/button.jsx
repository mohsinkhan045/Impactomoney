...
const CustomButton = ({button , onClick}) => {
  return (
    <button 
    onClick={onClick} className="relative inline-flex items-center justify-center px-8 py-2.5 overflow-hidden tracking-tighter text-white bg-gray-800 rounded-md group">
    ...
    <span className="relative text-base font-semibold">{button}</span>
  </button>
  );
}
