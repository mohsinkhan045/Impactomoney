...
function ChangePassword() {
  ...
  >
      ...
      <div className="p-5 w-full max-w-lg flex justify-center  bg-gradient-to-br from-white via-blue-100 to-gray-50  mt-4 border border-gray-300 shadow-lg rounded-xl">
